...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <form method="post" action="addCar">
        ...
        Car type: <input class="form-control form-control-sm" type="text" name="carType">
        Car make: <input class="form-control form-control-sm" type="text" name="make"/>
        Car model: <input class="form-control form-control-sm" type="text" name="model"/>
        Year: <input class="form-control form-control-sm" type="text" name="year"/>
        Mileage: <input class="form-control form-control-sm" type="text" name="mileage"/>
        Engine power: <input class="form-control form-control-sm" type="text" name="enginePower"/>
        ...
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            <label class="btn btn-secondary">
                <input type="radio" name="transmission" value="MANUAL" id="transmissionoption1" autocomplete="off"> Manual
            </label>
            <label class="btn btn-secondary">
        ...
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            ...
            <label class="btn btn-secondary">
                <input type="radio" name="bodyType" value="SEDAN" id="bodyoption6" autocomplete="off"> Sedan
            </label>
            <label class="btn btn-secondary">
        ...
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            ...
            <label class="btn btn-secondary">
                <input type="radio" name="color" value="BLACK" id="coloroption2" autocomplete="off"> Black
            </label>
            <label class="btn btn-secondary">
        ...
        Number of seats: <input class="form-control form-control-sm" type="text" name="seats"/><br/>
