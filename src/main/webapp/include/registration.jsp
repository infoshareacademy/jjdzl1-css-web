        ...
        <div class="card-body">
            ...
            <form class="needs-validation" action="register" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="phoneNumber" class="form-control" id="phoneNumber" placeholder="600123999" min="1000000" step="1" data-bind="value:inputphonenumber" required>
                </div>
